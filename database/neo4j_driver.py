...
class Neo4j_Driver:
	...
	def create_node_rel(self, a:NeoNode, b:NeoNode, r:NeoRelationship, a_id: int = None):
		a_rets = a.get_rets("a")
		b_rets = b.get_rets("b")
	...
	def match_nodes_rel(self, a:NeoNode, b:NeoNode, r:NeoRelationship, a_id: int = None, b_id: int = None):
		a_rets = a.get_rets("a")
		b_rets = b.get_rets("b")
